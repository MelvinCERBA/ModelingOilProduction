...
Pour chaque valeurs de $\sigma$ et de $a$, nous allons lancer l'algorithme d'optimisation 15 fois et calculer les moyennes du temps d'exécution et de la valeur du critère des courbes sigmoïdes obtenues.
